...
# saída o nome do time vencedor de uma partida de futebol. O 
# seu programa deve receber os nomes dos dois times da       
# partida e o número de gols marcados por cada um deles.     
# Vence a partida aquele time que marcar o maior número de   
# gols. Exiba a mensagem “EMPATE”, caso a partida não tenha  
# tido um vencedor.                                          
...
if gols1 > gols2: # Se o número de gols do time 1 for maior que o do time 2
  ...
  print(f"{time2} venceu") # Imprime "{time2} venceu"
